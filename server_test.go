...
func TestTokenize(t *testing.T) {
	_, err := request(apiURL+"/api/v1/tokenize",
		[]byte(`{"outsystem":"A5","requestorid":"123454","carddata":{"accountNumber":"5123456789012345","expiry":"2109","securityCode":"123"},"source":"ACCOUNT_ADDED_MANUALLY"}`),
	)
	if err != nil {
		t.Fatal(err)
	}
...
func TestGetAssets(t *testing.T) {
	_, err := request(apiURL+"/api/v1/getassets",
